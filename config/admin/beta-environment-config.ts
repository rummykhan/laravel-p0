...
import { ADMIN_REPO_NAME } from '../packages'

const APP_NAME = ADMIN_REPO_NAME;

export default {
    serviceName: `AdminWebApplication`,
    
    domainConfig: {
        hostedZoneName: `clickpattern.dev`,
        hostedZoneId: `Z03233892327430JQ2XMI`,
        domainName: `admin.clickpattern.dev`,
    },
    ...
    secretsConfig: {
        ...
        secretName: 'admin/beta/secrets',
        secretArn: `arn:aws:secretsmanager:us-east-1:108271872087:secret:admin/beta/secrets-Z3Br7f`
    },
